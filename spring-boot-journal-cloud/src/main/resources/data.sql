-- USERS IN JOURNAL
-- INSERT INTO ACCOUNT(account_name, password) VALUES ('springboot', 'P@ssw0rd');
-- INSERT INTO ACCOUNT(account_name, password) VALUES ('springsecurity', 'P@ssw0rd');
...
INSERT INTO ENTRY(title, summary, created) VALUES ('스프링 부트 클라우드', '클라우드 파운드리를 응용한 스프링 부트를 공부했다.', '2017-01-02 09:00:00.00');